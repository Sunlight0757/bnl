                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $usuario['nome_jur']; ?>" name="nome_jur" class="form-control">
                                </div>  
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="">CNPJ</label>
                                    <input type="text" value="<?php echo $usuario['cnpj']; ?>" name="cnpj" class="form-control">
                                </div>  
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <a href="painel.php" class="btn btn-primary btn-round"><i class="ti-arrow-left"></i> Voltar</a>
